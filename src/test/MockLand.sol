...
contract MockERC721 is ERC721, SuperOperators, MetaTransactionReceiver {
    ...
    function ownerOf(uint256 id) public override view returns (address owner) { // TODO: does not return owner
        owner = _ownerOf(id);
    ...
    function batchTransferFrom(address from, address to, uint256[] memory ids, bytes memory data) public {
...
abstract contract MockLand is MockERC721 {
