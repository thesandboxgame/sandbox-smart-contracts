 ...
 */
abstract contract WithPermitUpgradable is Initializable, EIP712Upgradeable {
    ...
    function __WithPermitUpgradable_init(string memory name) internal onlyInitializing {
        ...
        __Permit_init_unchained(name);
    }

    function __Permit_init_unchained(string memory name) internal onlyInitializing {
