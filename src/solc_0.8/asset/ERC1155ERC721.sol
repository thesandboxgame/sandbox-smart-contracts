...
contract ERC1155ERC721 is WithMetaTransaction, WithSuperOperators, IERC1155, IERC721 {
    ...
    function burnFrom(
        ...
        require(from != address(0), "FROM==0");
        require(_isAuthorized(from) || isApprovedForAll(from, msg.sender), "");
