...
contract PeopleOfCryptoV3 is ERC721EnumerableUpgradeable, OwnableUpgradeable, ReentrancyGuard {
    ...
    function personalize(
        ...
        require(signatureIds[_signatureId] == 0, "signatureId already used (changed)");
        require(
