...
// import "../../../common/interfaces/IAssetERC721Token.sol"; // TODO: AssetERC721Token interface
...
contract AssetERC721Tunnel is FxBaseRootTunnel, IERC721MandatoryTokenReceiver, ERC2771Handler, Ownable, Pausable {
    ...
    function batchTransferToL2(
        ...
        AssetERC721Token(rootToken).batchTransfer(_msgSender(), address(this), ids, data);
    ...
    function _processMessageFromChild(bytes memory message) internal override {
        ...
        for (uint256 index = 0; index < ids.length; index++) {
            AssetERC721Token(rootToken).transfer(address(this), to, ids[index], data); // TODO: check data format
