...
contract EventBasedCatalystMinter is MetaTransactionReceiver {
    ...
    function mint(
        ...
        // TODO EMIT EVENT _catalystRegistry.setCatalyst(id, catalystToken, gemIds);
        return id;
    }
    ...
    function _mintAssets(
        ...
        for (uint256 i = 0; i < tokenIds.length; i++) {
            ...
            // TODO EMIT EVENT _catalystRegistry.setCatalyst(tokenIds[i], asset.catalystToken, asset.gemIds);
        }
    }
    ...
    function _changeCatalyst(
        ...
        // TODO EMIT EVENT _catalystRegistry.setCatalyst(assetId, catalystToken, gemIds);
    ...
    function _addGems(
        ...
        require(assetId & IS_NFT > 0, "NEED TO BE AN NFT"); // Asset (ERC1155ERC721.sol) ensure NFT will return true here and non-NFT will reyrn false
        // TODO EMIT EVENT CatalystRegistry.CatalystStored memory catalyst = _catalystRegistry.getCatalyst(assetId);
        // (, uint16 maxGems, , , ) = catalyst.token.getMintData();
        // require(gemIds.length + catalyst.gems.length <= maxGems, "too many gems");

        // TODO EMIT EVENT _catalystRegistry.addGems(assetId, gemIds);
