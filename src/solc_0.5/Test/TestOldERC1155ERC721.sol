...
contract TestOldERC1155ERC721 is SuperOperators, ERC1155, ERC721 {
    ...
    uint256 internal constant IS_NFT_OFFSET_MULTIPLIER = uint256(2)**(256 - 160 - 1);
    uint256 internal constant PACK_ID_OFFSET_MULTIPLIER = uint256(2)**(256 - 160 - 1 - 32 - 40);
    uint256 internal constant PACK_NUM_FT_TYPES_OFFSET_MULTIPLIER = uint256(2)**(256 - 160 - 1 - 32 - 40 - 12);
    uint256 internal constant NFT_INDEX_OFFSET = 63;

    uint256 internal constant IS_NFT =            0x0000000000000000000000000000000000000000800000000000000000000000;
    uint256 internal constant NOT_IS_NFT =        0xFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF7FFFFFFFFFFFFFFFFFFFFFFF;
    uint256 internal constant NFT_INDEX =         0x00000000000000000000000000000000000000007FFFFFFF8000000000000000;
    uint256 internal constant NOT_NFT_INDEX =     0xFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF800000007FFFFFFFFFFFFFFF;
    uint256 internal constant URI_ID =            0xFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF000000007FFFFFFFFFFFF800;
    uint256 internal constant PACK_ID =           0xFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF000000007FFFFFFFFF800000;
    uint256 internal constant PACK_INDEX =        0x00000000000000000000000000000000000000000000000000000000000007FF;
    uint256 internal constant PACK_NUM_FT_TYPES = 0x00000000000000000000000000000000000000000000000000000000007FF800;

    uint256 internal constant MAX_SUPPLY = uint256(2)**32 - 1;
    uint256 internal constant MAX_PACK_SIZE = uint256(2)**11;
    ...
    mapping(address => uint256) internal _numNFTPerAddress; // erc721
    mapping(uint256 => uint256) internal _owners; // erc721
    mapping(address => mapping(uint256 => uint256)) internal _packedTokenBalance; // erc1155
    mapping(address => mapping(address => bool)) internal _operatorsForAll; // erc721 and erc1155
    mapping(uint256 => address) internal _erc721operators; // erc721
    ...
    mapping(uint256 => uint32) internal _nextCollectionIndex; // extraction

    mapping(address => address) internal _creatorship; // creatorship transfer

    mapping(address => bool) internal _bouncers; // the contracts allowed to mint
    mapping(address => bool) internal _metaTransactionContracts; // native meta-transaction support
