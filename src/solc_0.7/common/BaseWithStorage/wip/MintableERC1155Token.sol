...
abstract contract MintableERC1155Token is ERC1155BaseToken {
    ...
    function mint(
        ...
        _packedTokenBalance[to][bin] = ObjectLib32.updateTokenBalance(
    ...
    ) ERC1155BaseToken(metaTransactionContract, admin) {
