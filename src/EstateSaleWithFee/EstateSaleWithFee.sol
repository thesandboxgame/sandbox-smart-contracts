...
/**
 * @title Estate Sale With Fee contract with referral that supports also DAI and ETH as payment
 * @notice This contract manages the sale of our lands as Estates and takes a fixed fee from each sale
 */
