module.exports = async ({deployments}) => {
  ...
  if (!isSuperOperator) {
    ...
    await sendTxAndWait({from: currentSandAdmin, gas: 100000, skipError: true}, 'Sand', 'setSuperOperator', metaTxProcessor.address, true);
  }
  ...
  if (!isExecutionOperator) {
    ...
    await sendTxAndWait({from: currentExecutionSandAdmin, gas: 100000, skipError: true}, 'Sand', 'setExecutionOperator', metaTxProcessor.address, true);
  }
};
