...
library TokenIdUtils {
    // Layer masks
    uint256 constant CHAIN_MASK = 0xFFFFFF;
    ...
    uint256 constant TIER_SHIFT = 184;
    uint256 constant NONCE_SHIFT = 192;
    uint256 constant REVEAL_NONCE_SHIFT = 217;
    ...
    function generateTokenId(
        ...
        tokenId = tokenId =
            ...
            (uint256(block.chainid) << CHAIN_SHIFT) |
    ...
    function getChainIndex(uint256 tokenId) internal pure returns (uint24) {
        return uint24((tokenId >> CHAIN_SHIFT) & CHAIN_MASK);
    }
