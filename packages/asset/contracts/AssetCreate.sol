    ...
    PausableUpgradeable
{
    ...
    function lazyCreateMultipleAssets(
        ...
        uint256 balance = IERC1155(address(catalystContract)).balanceOf(mintData.caller, mintData.tiers[0]);
        uint256 balanceThis = IERC1155(address(catalystContract)).balanceOf(address(this), mintData.tiers[0]);
        console.log(balance);
