    ...
    EIP712Upgradeable
{
    ...
    bytes32 public constant REVEAL_TYPEHASH =
        keccak256(
            "Reveal(address recipient,uint256 prevTokenId,uint256[] amounts,string[] metadataHashes,bytes32 revealHash)"
        );
    ...
    bytes32 public constant INSTANT_REVEAL_TYPEHASH =
        keccak256(
            "InstantReveal(address recipient,uint256 prevTokenId,uint256[] amounts,string[] metadataHashes,bytes32 revealHash)"
        );
    ...
    /// @param revealHash A revealHash that is a random bytes32 generated by the TSB backend for the tx
    function revealMint(
        ...
        require(revealHashesUsed[revealHash] == false, "Invalid revealHash");
        revealHashesUsed[revealHash] = true;
        require(
        ...
        _revealAsset(prevTokenId, metadataHashes, amounts, revealHash);
    }
    ...
    /// @param revealHashes A revealHash array providing a random bytes32 generated by the TSB backend for each tokenId to be revealed
    ...
    function _revealAsset(
        ...
        emit AssetRevealMint(_msgSender(), prevTokenId, amounts, newTokenIds, revealHash);
    }
    ...
    /// @param revealHash The revealHash used for this particular prevTokenId
