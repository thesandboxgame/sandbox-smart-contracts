...
*Include a high level description of this package here for this example*

This project is based on the template generated by hardhat when run in an empty directory.
...
Testing Use `yarn test` inside `packages/<package>` to run tests locally for just this package
...
1. Add whatever dependencies you like inside your package; this template is for hardhat usage. Openzeppelin contracts
   are optional, but, we highly recommend using them.
