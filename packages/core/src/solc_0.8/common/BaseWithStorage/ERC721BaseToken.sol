...
contract ERC721BaseToken is IERC721Upgradeable, WithSuperOperators, ERC2771Handler {
    ...
    /// @dev By overriding this function in an implementation which inherits this contract, you can enable versioned tokenIds without the extra overhead of writing to a new storage slot in _owners each time a version is incremented.
