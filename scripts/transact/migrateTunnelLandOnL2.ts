...
const uniqueQuadsOnTunnelL2 = JSON.parse(
  fs.readFileSync('./tunnel_polygon_unique_quads.json').toString()
);
...
const quads3x3 = uniqueQuadsOnTunnelL2.quads3x3OnLayer2;
const quads6x6 = uniqueQuadsOnTunnelL2.quads6x6OnLayer2;
const quads12x12 = uniqueQuadsOnTunnelL2.quads12x12OnLayer2;
const quads24x24 = uniqueQuadsOnTunnelL2.quads24x24OnLayer2;
